# Prop console chrome — px-dynamite-v1
...
| Config | `config.html` | Game mode (Basic I/O / Code Entry), eight named codes A–H, target gram sums (reject impossible), charge weights in g. |
...
http://127.0.0.1:8094/index.html — demo mocks auto-on for localhost.
