...
# Legacy ParadoxProp: POST /ota
# New px-dynamite-v1: POST /api/ota/upload
#
# Usage:
#   .\scripts\ota_upload.ps1 -HostAddress 192.168.8.xx -Legacy
#   .\scripts\ota_upload.ps1 -HostAddress 192.168.8.xx
param(
    [string]$HostAddress = "",
    [string]$Url = "",
    [string]$Bin = "",
...
if (-not $Bin) {
    $Bin = Join-Path $root "build\px-dynamite-v1.bin"
}
